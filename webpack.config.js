...
* @Last Modified time: 2018-07-19 16:02:08
...
var config = {
    ...
    output: {
        path        : __dirname + '/dist/',
        // publicPath  : WEBPACK_ENV === 'online' ? '//s.mmall.com/admin-fe/dist/' : '/dist/',
        publicPath  : '//s.donggedada.top/admin-fe/dist/',
        filename    : 'js/[name].js'
    },
    resolve: {
        alias: {
